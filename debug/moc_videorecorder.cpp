...
QT_MOC_LITERAL(3, 29, 12) // "errorMessage"
    ...
    "VideoRecorder\0errorOccurred\0\0errorMessage"
};
...
void VideoRecorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VideoRecorder::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoRecorder::errorOccurred)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoRecorder::errorOccurred(const QString & _t1)
{
